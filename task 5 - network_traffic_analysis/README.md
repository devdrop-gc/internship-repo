...
1. **Installed Wireshark**  
   Downloaded and installed the latest stable version of Wireshark from [wireshark.org](https://www.wireshark.org) along with Npcap (required for packet capturing on Windows).
...
## 📸 Screenshots
![Interface Selection](screenshots/Selecting_Interface)
![Filtered Packets](screenshots/Filtered_Packets)

**Note:** Most modern traffic is encrypted (TLS). HTTP was generated by visiting http://example.com intentionally. Also submitted `.pcapng` file is anonymized
